  ...
  <div>
    <div style="width:100%;background-color:white">
      ...
      <div v-if="chartdata">
        ...
        <NewBarChart :data="chartdata" :dateType="dateType"></NewBarChart>
        <!-- <LineChart :data="chartdata" :dateType="dateType"></LineChart>
        <LineChart :data="chartdata" :dateType="dateType"></LineChart>-->
      </div>
...
export default {
  components: { LineChart, HistogramChart, BarChart, NewBarChart },
  data: function() {
    return {
      data: null,
      bardata: null,
    ...
    sendApi2() {
      ...
      this.axios.get(url).then(response => {
        ...
        for (let i in response.data) {
          ...
          response.data[i]["最高標借單價"] == null
            ? hisObj.value[0].push(0)
